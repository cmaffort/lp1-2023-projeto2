...
public class ListarProntuario extends HttpServlet {
    ...
    public static String execute(HttpServletRequest request) {
        ...
        if (origem.contains("Morador")) 
            jsp = "/GestãoProntuario.jsp";
       
        
        try {
            String moradorCPF = request.getParameter("moradorCPF");
            List<Prontuario> prontuarios = service.listarPorMorador(moradorCPF);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListarProntuario</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListarProntuario at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
